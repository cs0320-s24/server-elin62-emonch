...
public class LoadCSVHandlerTest {
    ...
    @Mock
    private CSVDataSource<MyDataClass> mockDataSource;


    private final String validFilePath = "/Users/ennomonch/Desktop/CS32/server-elin62-emonch/src/main/java/edu/brown/cs/student/main/census/ri_city_town_income_ACS.csv";
    ...
    void testHandleValidFilePath() throws Exception {
        ...
        when(mockDataSource.getData()).thenReturn(List.of(new MyDataClass(Collections.singletonList("/Users/ennomonch/Desktop/CS32/server-elin62-emonch/src/main/java/edu/brown/cs/student/main/census/ri_city_town_income_ACS.csv"))));
